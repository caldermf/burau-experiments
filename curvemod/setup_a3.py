...
# A3 as generated by the Cartan Type
# Oriented version
...
coxeter_matrix = np.array([[1,3,2],[3,1,3],[2,3,1]])
dynkin_graph = {1: set([2]), 2: set([1,3]), 3: set([2])}
dynkin_ograph={1:set([2]), 2: set([3]), 3:set([])}
...
###################################
# END OF A3-specific definitions  #
###################################
