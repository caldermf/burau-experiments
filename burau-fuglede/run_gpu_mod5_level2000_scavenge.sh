#!/usr/bin/env bash
#SBATCH --job-name=burau_gpu_p5_L2000
...
RUN_DIR="$ROOT/manual_runs/gpu_mod5_level2000_scavenge"
LOG_FILE="$RUN_DIR/search.log"
HIT_FILE="$RUN_DIR/hit.txt"
STATUS_FILE="$RUN_DIR/status.txt"
BUILD_LOG="$RUN_DIR/build.log"
BIN="$RUN_DIR/burau_exact_modp_gpu_p5_L2000"

PRIME=5
START_LEVEL=1
STOP_LEVEL=2000
MAX_LEVEL=2000
MAX_SURVIVORS_PER_LEVEL=335544320
