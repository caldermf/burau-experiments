...
Usage:
    python -m mod7.decode_words mod7/results/projlen0/projlen0_length042.pt
...
def main():
    if len(sys.argv) < 2:
        ...
        print()
        print("Examples:")
        print("  python -m mod7.decode_words mod7/results/projlen0/projlen0_length042.pt")
        print("  python -m mod7.decode_words mod7/results/projlen0")
        print("  python -m mod7.decode_words mod7/results/projlen0 --verify")
        sys.exit(1)
