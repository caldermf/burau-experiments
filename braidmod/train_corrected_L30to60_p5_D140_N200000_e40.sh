...
#SBATCH --job-name=braidmod-train-p5-L30to60-D140-e40
...
OUT_DIR="$REPO_ROOT/artifacts/garside_mlp_L30to60_p5_D140_N200000_e40"
...
"$PYTHON_PATH" plot_training_curves.py \
  --log "$LOG_PATH" \
  --out "$PLOT_PATH" \
  --title "Corrected Burau Training Curves (L30to60, p=5, D=140, N=200000, 40 epochs)"
