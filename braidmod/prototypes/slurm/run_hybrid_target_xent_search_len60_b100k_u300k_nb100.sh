#!/usr/bin/env bash
# Run hybrid reservoir search with equal-weight normalized projlen and target cross-entropy.

#SBATCH --job-name=braidmod-search-hybridxent-l60-b100k-u300k-nb100
...
OUT_JSON="$REPO_ROOT/artifacts/reservoir_search_hybrid_target_xent_gpu_len60_b100k_u300k_nb100_boot5.json"
OUT_PNG="$REPO_ROOT/artifacts/reservoir_search_hybrid_target_xent_gpu_len60_b100k_u300k_nb100_boot5_best_projlen.png"
...
echo "Starting hybrid target_xent search at $(date)"
echo "Host: $(hostname)"
...
out_json = Path("artifacts/reservoir_search_hybrid_target_xent_gpu_len60_b100k_u300k_nb100_boot5.json")
out_png = Path("artifacts/reservoir_search_hybrid_target_xent_gpu_len60_b100k_u300k_nb100_boot5_best_projlen.png")
...
ax.set_title("Best Projlen by Length (hybrid projlen + target_xent search)")
