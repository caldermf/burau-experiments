#!/usr/bin/env bash
# Regenerate the L30..60 p=5 D=140 uniform dataset using the corrected/projective Burau normalization.

#SBATCH --job-name=braidmod-gen-p5-L30to60-200k-D140-corrected
...
OUT_PATH="$REPO_ROOT/data/burau_gnf_L30to60_p5_D140_N200000_uniform.json"
...
echo "Starting corrected/projective dataset regeneration at $(date)"
echo "Host: $(hostname)"
