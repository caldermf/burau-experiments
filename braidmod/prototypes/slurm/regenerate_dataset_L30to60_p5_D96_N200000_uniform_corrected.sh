#!/usr/bin/env bash
# Regenerate the L30..60 p=5 D=96 uniform dataset using the corrected Burau normalization.
# This intentionally overwrites the existing dataset path after a successful full write.

#SBATCH --job-name=braidmod-gen-p5-L30to60-200k-corrected
...
OUT_PATH="$REPO_ROOT/data/burau_gnf_L30to60_p5_D96_N200000_uniform.json"
