#!/usr/bin/env bash
# Compare pure projlen, pure avg5 target_xent maximize, and frontier-distance avg5 target_xent search.

#SBATCH --job-name=braidmod-search-frontiercmp-l40
...
PROJLEN_JSON="$REPO_ROOT/artifacts/reservoir_search_projlen_gpu_len40_b20k_u60k_nb64_boot5.json"
XENT_JSON="$REPO_ROOT/artifacts/reservoir_search_target_xentavg5max_gpu_len40_b20k_u60k_nb64_boot5.json"
FRONTIER_JSON="$REPO_ROOT/artifacts/reservoir_search_frontier_target_xentavg5_gpu_len40_b20k_u60k_nb64_boot5.json"
OUT_PNG="$REPO_ROOT/artifacts/reservoir_search_frontier_target_xentavg5_gpu_len40_b20k_u60k_nb64_boot5_best_projlen_compare.png"
...
echo "Starting comparison run at $(date)"
echo "Host: $(hostname)"
...
projlen_json = "artifacts/reservoir_search_projlen_gpu_len40_b20k_u60k_nb64_boot5.json"
xent_json = "artifacts/reservoir_search_target_xentavg5max_gpu_len40_b20k_u60k_nb64_boot5.json"
frontier_json = "artifacts/reservoir_search_frontier_target_xentavg5_gpu_len40_b20k_u60k_nb64_boot5.json"
out_png = Path("artifacts/reservoir_search_frontier_target_xentavg5_gpu_len40_b20k_u60k_nb64_boot5_best_projlen_compare.png")
