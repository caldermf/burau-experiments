#!/usr/bin/env bash
# Run pure target-cross-entropy reservoir search with 5-step running-average scoring, maximizing target_xent.

#SBATCH --job-name=braidmod-search-xentavg5max-l60-b100k-u300k-nb100
...
OUT_JSON="$REPO_ROOT/artifacts/reservoir_search_target_xentavg5max_gpu_len60_b100k_u300k_nb100_boot5.json"
OUT_PNG="$REPO_ROOT/artifacts/reservoir_search_target_xentavg5max_gpu_len60_b100k_u300k_nb100_boot5_best_projlen.png"
...
echo "Starting target_xent avg5 maximize search at $(date)"
echo "Host: $(hostname)"
...
out_json = Path("artifacts/reservoir_search_target_xentavg5max_gpu_len60_b100k_u300k_nb100_boot5.json")
out_png = Path("artifacts/reservoir_search_target_xentavg5max_gpu_len60_b100k_u300k_nb100_boot5_best_projlen.png")
...
ax.set_title("Best Projlen by Length (target_xent avg5 maximize search)")
