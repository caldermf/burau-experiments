#!/usr/bin/env bash
#SBATCH --job-name=braidmod-train-p5-L15to40
...
OUT_DIR="$REPO_ROOT/artifacts/garside_mlp_L15to40_p5_D96_N100000_corrected"
...
"$PYTHON_PATH" plot_training_curves.py \
  --log "$LOG_PATH" \
  --out "$PLOT_PATH" \
  --title "Corrected Burau Training Curves (L15to40, p=5, D=96, N=100000)"
