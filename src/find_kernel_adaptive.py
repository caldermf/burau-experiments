...
def find_kernel(
    ...
    print()
    print("FFT Tiers (D must satisfy D >= 8*level + 1):")
    print("  Levels 1-7:    D=65,   fft_size=256")
    print("  Levels 8-15:   D=129,  fft_size=512")
    print("  Levels 16-31:  D=257,  fft_size=1024")
    print("  Levels 32-63:  D=513,  fft_size=2048")
    print("  Levels 64-127: D=1025, fft_size=4096")
    print("  Levels 128+:   D=2049, fft_size=8192")
    print()
