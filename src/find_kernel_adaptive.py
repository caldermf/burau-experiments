...
def find_kernel(
    ...
    print()
    print("FFT Tiers (D >= 8*level + 1 required):")
    print("  Levels 1-8:    D=65,   fft_size=256")
    print("  Levels 9-16:   D=129,  fft_size=512")
    print("  Levels 17-32:  D=257,  fft_size=1024")
    print("  Levels 33-64:  D=513,  fft_size=2048")
    print("  Levels 65-128: D=1025, fft_size=4096")
    print("  Levels 129+:   D=2049, fft_size=8192")
    print()
