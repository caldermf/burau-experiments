...
def find_kernel(
    ...
    print()
    print("FFT Tiers:")
    print("  Levels 1-15:   D=65,   fft_size=128")
    print("  Levels 16-30:  D=129,  fft_size=256")
    print("  Levels 31-50:  D=257,  fft_size=512")
    print("  Levels 51-80:  D=513,  fft_size=1024")
    print("  Levels 81-120: D=1025, fft_size=2048")
    print("  Levels 121+:   D=2049, fft_size=4096")
    print()
